...
class Chat extends StatelessWidget {
  ...
  const Chat({
    ...
    this.receiverId,
    this.receiverAvatar,
    this.receiverName}) : super(key: key);
...
class ChatScreen extends StatefulWidget {
  ...
  const ChatScreen({
    Key key,
    this.receiverId,
    this.receiverAvatar}) : super(key: key);
  @override
...
class ChatScreenState extends State<ChatScreen> {
...

  {
    ...
    Firestore.instance.collection("users").document(id).updateData({'ChatiingWith': receiverId});
    setState(() {
        ...
        return Row(
          children: <Widget>[
            ...
            : document["type"] == 1
             ...
             child: Image.asset("images/images/img_not_available.jpeg", width:  200.0,height: 200.0,fit: BoxFit.cover,),
             borderRadius: BorderRadius.all(Radius.circular(8.0)),
    ...
    if(contentMsg !="")
      {
        ...
        listScrollController.animateTo(0.0,duration: Duration(microseconds:300), curve: Curves.easeInOut);
